...
class Button extends Component {
  ...
  handleClick() {
    this.setState(
      (prevState) => ({ numberOfClicks: prevState.numberOfClicks + 1 }),
      () => {
  ...
  handleClick2() {
    this.setState({
      salutation:
        this.state.salutation === "Bom Dia "
          ? this.state.salutation + "Galerinha!!!"
           : "Bom Dia ",
    });
  }
  ...
  handleClick3() {
    this.setState((prevState) => ({
      numberOfClicksReverse: prevState.numberOfClicksReverse - 1,
    }));
    ...
    return (
      <div className="container">
        <button
          ...
          style={{backgroundColor: this.getButtonColor(this.state.numberOfClicks),}}
        >
        ...
        <button
          ...
          style={{backgroundColor: this.getButtonColor(this.state.numberOfClicksReverse),}}
        >
