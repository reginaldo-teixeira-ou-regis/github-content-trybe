...
CREATE TABLE
    IF NOT EXISTS travels (
        ...
        FOREIGN KEY (driver_id) REFERENCES drivers(id) ON DELETE CASCADE ON UPDATE CASCADE,
        FOREIGN KEY (travel_status_id) REFERENCES travel_status(id) ON DELETE CASCADE ON UPDATE CASCADE
    );
...
INSERT INTO
    travel_status (name)
VALUES ('Aguardando Motorista'), ('Motorista a Caminho'), ('Viagem em Andamento'), ('Viagem Finalizada');
...
VALUES (
        'Doriana Quintal',
        'doriana.quintal@acme.com',
        '(49) 3882-3117'
    ), (
        'Leo Sampaio',
        'leo.sampaio@acme.com',
        '(66) 3692-7793'
    ), (
        'Anabela Monteiro',
        'anabela.monteiro@acme.com',
        '(49) 2134-2152'
    ), (
        'Estêvão Paranhos',
        'estevao.paranhos@acme.com',
        '(82) 2166-2413'
    ), (
        'Mateo Vidigal',
        'mateo.vidigal@acme.com',
        '(51) 2303-7355'
    );
...
INSERT INTO
    cars (model, color, license_plate)
VALUES (
        'Renault Sandero',
        'Branco',
        'NCA-0956'
...
VALUES ('Liana Cisneiros'), ('Fábio Frazão'), ('Anastacia Bicalho'), ('Samara Granjeiro'), ('Levi Teixeira');

INSERT INTO
    drivers_cars (driver_id, car_id)
