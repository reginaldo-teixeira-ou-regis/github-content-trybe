...
<details>
  ...
  **⚠️ Para rodar os scripts fora do container, use o prefixo `env $(cat .env)` antes dos comandos para carregar as variáveis de ambiente. Por exemplo: `env $(cat .env) npm test` ⚠️**
...
# Requisitos Obrigatórios do Projeto TrybeSmith
