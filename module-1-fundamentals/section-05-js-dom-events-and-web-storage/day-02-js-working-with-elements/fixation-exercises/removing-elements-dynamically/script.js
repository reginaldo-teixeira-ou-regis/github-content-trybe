let arrayExercises1 = [
  ...
  /*4*/
  document.getElementsByClassName("New Son of Son")[0].parentNode.parentNode
    .nextElementSibling;
  
  /*Remova todos os elementos filhos de paiDoPai exceto pai, elementoOndeVoceEsta e primeiroFilhoDoFilho.*/
  
  /*let contentPai = document.querySelectorAll("#pai");
  for(let i = 0; i < contentPai.length; i += 1) {
      let element = contentPai[i];
      if(element.innerText.includes('primeiroFilho')) {
          contentPai.removeChild(element);
      }
  }*/
  
  /*let contentPai = document.querySelector("#pai");
  let firstSon = document.querySelector("#pai primeiroFilho");
  contentPai.removeChild(firstSon);
