...
- A função `calcArea` deve retornue:
365
​
366
...
​
408
## 7 - Crie uma função de Caça ao Ratoar o valor 5 quando receber o parâmetro `base` com o valor 5 e o parâmetro `height` com o valor 2;
