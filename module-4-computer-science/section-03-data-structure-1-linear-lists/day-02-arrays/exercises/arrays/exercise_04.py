...
I - instantes de entrada e saídas em uma biblioteca II -
um número que represente um instante a ser buscado.
...
def students_in_instant1(arrivals, departures, time_instant):
    return sum(
...
print(students_in_instant1([1, 2, 3], [3, 2, 7], 4))  # 1
