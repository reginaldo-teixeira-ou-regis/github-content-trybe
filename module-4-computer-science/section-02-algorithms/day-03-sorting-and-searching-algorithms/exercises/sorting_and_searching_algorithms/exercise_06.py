...
# Como os testes demoram a rodar, resolva o
# problema rodando o mínimo de testes possíveis.

# entrada: [True, True, True, True, False, False, False]  # saída: 4

# entrada: [True, True, False, False, False, False, False]  # saída: 2

# 💡 Curiosidade: O comando git bisect executa de maneira similar
# a este exercício se implementado de forma eficiente 😂.
