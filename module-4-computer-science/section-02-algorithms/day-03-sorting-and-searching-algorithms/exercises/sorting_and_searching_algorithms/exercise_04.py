# Compare o tempo de execução do algoritmo merge_sort e
# bubble_sort para uma entrada de 10.000 valores aleatórios.
...
# O(n log n) em média.
# Mesmo em um pior cenário, onde ao embaralharmos os dois arrays,
# tornando-os inversamente ordenados, o merge sort seria mais rápido,
# pois sua complexidade ainda seria O(n log n) e o bubble sort teria
