# Utilizando o arquivo pokemons.json,
# vamos escrever um programa que sorteie um pokemon aleatoriamente.
# O programa deve perguntar à pessoa usuária
# “Quem é esse pokemon?” até que ela o acerte.
...
# 🦜 Você pode utilizar o método choice do modulo random
# para sortear aleatoriamente um pokemon.
